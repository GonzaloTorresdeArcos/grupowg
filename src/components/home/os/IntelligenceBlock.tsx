    ...
    <section className="py-28 md:py-36 bg-ink text-bone relative overflow-hidden border-y border-foreground/5">
      ...
      <div className="container-tight relative">
        <Reveal>
          ...
          <p className="mt-6 max-w-2xl text-bone/65 text-lg leading-relaxed">{t("lead")}</p>
              ...
              <Reveal key={meta.t} delay={i * 70}>
                <article className="bg-ink p-7 md:p-8 h-full flex flex-col hover:bg-bone/[0.02] transition-colors">
                  <div className="flex items-center justify-between mb-7">
                    ...
                    <span className="font-mono text-[10px] text-bone/40">{meta.code}</span>
                  </div>
                  <h3 className="heading-tight text-bone text-xl">{meta.t}</h3>
