...
export const AnniversarySection = () => (
  <section className="py-20 md:py-28 lg:py-32 bg-background text-foreground overflow-hidden">
    <div className="container-tight grid gap-12 md:gap-10 lg:gap-16 md:grid-cols-12 items-center">
      ...
      <Reveal delay={120} className="md:col-span-7">
        ...
        <h2 className="heading-display text-foreground text-4xl md:text-5xl lg:text-6xl text-balance leading-[1.05] md:leading-[1.02]">
          50 años resolviendo.
        </h2>
        <div className="mt-6 md:mt-8 space-y-4 text-foreground/70 text-base md:text-lg leading-[1.65] md:leading-[1.6] max-w-xl">
