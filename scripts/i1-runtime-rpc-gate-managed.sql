-- =====================================================================
-- I1 · variante del runtime gate para ejecucion administrada (rol privilegiado).
-- Identica a scripts/runtime-rpc-gate.sql salvo que NO escribe en
-- public.ops_gate_log (regla I1: cero cambios sobre objetos ops_*).
-- =====================================================================
...
BEGIN
  ...
  -- (I1) escritura en ops_gate_log omitida: regla 'cero cambios ops_*'
