...
DECLARE
  ...
  casos text[][] := ARRAY[
    ...
    ['ops_sla','jun-2026 sin filtros',
     $q$SELECT public.ops_sla('2026-06-01','2026-06-30')$q$,
     'src/pages/ops/SLA.tsx','n'],
    ['ops_sla','12M jul25-jun26',
     $q$SELECT public.ops_sla('2025-07-01','2026-06-30')$q$,
     'src/pages/ops/SLA.tsx','n'],
    ...
    ['ops_dispersion','jun-2026 sin filtros',
     $q$SELECT public.ops_dispersion('2026-06-01','2026-06-30')$q$,
     'src/pages/ops/Dispersion.tsx','n'],
    ['ops_dispersion','12M jul25-jun26',
     $q$SELECT public.ops_dispersion('2025-07-01','2026-06-30')$q$,
     'src/pages/ops/Dispersion.tsx','n'],
